...
export const competitionYears = {
  ...
  2024: {
    status: 'final', label: '2024 Final Results', leaderboard: [],
    prizes: [
      { category: 'Tournament champion', detail: 'Al Cyster · 148 (+5) · $140', winner: true },
      // { category: 'Round 1 closest to the pin', detail: 'Hole 3 Raul Luna · Hole 7 Al Cyster · Hole 12 Chris Trela · Hole 15 Tony Monaco' },
      // { category: 'Round 1 skins', detail: 'Matthew Kosiba $176 · Joe O’Connor $88 · Raul Luna $88 · Tyler Bozynski $88' },
      // { category: 'Round 1 team net', detail: 'Raul Luna & Tyler Bozynski · 65 · $50/team' },
      // { category: 'Round 1 longest drive', detail: 'Hole 5 Adam Murray · Hole 17 Tyler Bozynski' },
    ...
    teeTimeGroups: [
      { label: 'Archived tee times', course: 'Details unavailable', rows: [] },
    ],
  },
  2023: {
    status: 'final', label: '2023 Final Results', leaderboard: [],
    prizes: [
      { category: 'Tournament champion', detail: 'Tyler Bozynski · 143 (E) · $140', winner: true },
    ],
    teeTimeGroups: [
      { label: 'Archived tee times', course: 'Details unavailable', rows: [] },
    ],
  ...
  2022: {
    status: 'final', label: '2022 Final Results', leaderboard: [],
    prizes: [
      { category: 'Tournament champion', detail: 'Raul Luna · 142 (-1) · $0', winner: true },
    ],
    teeTimeGroups: [
      { label: 'Archived tee times', course: 'Details unavailable', rows: [] },
    ],
